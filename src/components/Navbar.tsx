    ...
    <header className="sticky top-0 z-40 bg-slate-900/95 backdrop-blur border-b border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            {/* Live Synchronized Clock & Telemetry Pill */}
            <div className="hidden lg:flex items-center space-x-2 text-xs bg-slate-950/90 px-3 py-1.5 rounded-lg border border-slate-800 text-slate-300 font-mono shadow-inner">
              ...
              <button
                ...
                title="Re-synchronize with NTP Atomic Server & INSAT Satellite"
                className="p-0.5 text-slate-400 hover:text-emerald-400 transition"
              >
